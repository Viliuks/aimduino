...
std::map<unsigned short, GunData::data> weaponKeys{
	{1, GunData::assault_rifle},
	{2, GunData::mp5},
	{3, GunData::m249},
	{4, GunData::lr_rifle}
};
...
std::map<unsigned short, ModifierData::data> modifierKeys{
	{0, ModifierData::none},
	{1, ModifierData::silencer},
	{2, ModifierData::muzzle_boost},
	{3, ModifierData::x8_scope},
	{4, ModifierData::x16_scope},
	{5, ModifierData::muzzle_brake}
};
...
std::string SetWeapon(GunData::data s, ModifierData::data mod) {
	std::string rctbl = "2," + std::to_string(s.bullet_timeout * mod.timeOffset);
